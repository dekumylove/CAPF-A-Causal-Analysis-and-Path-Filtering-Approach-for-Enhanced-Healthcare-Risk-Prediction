...
class StageAware(nn.Module):
    def __init__(self, input_dim, output_dim, hidden_dim, num_rel=11, num_feat=2850, num_visit=6, max_feat = 32, max_target=4, Lambda=0.1, bidirectional=True, device=torch.device('cuda')):
        ...
        for _ in range(num_rel):
            # relation-sepcific representation
